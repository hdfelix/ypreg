...
ActiveRecord::Schema.define(version: 20180518141439) do
  ...
  create_table "hospitality_assignments", force: :cascade do |t|
  ...
  add_index "hospitality_assignments", ["event_id"], name: "index_hospitality_assignments_on_event_id", using: :btree
